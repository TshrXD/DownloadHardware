...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./style/home-header.css">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="custompc.php">Custom Pc Build</a>
      <a class="nav-item nav-link" href="customky.php">Custom Keybord</a>
      ...
      <a class="nav-item nav-link" href="login.php">Log in</a>
		<a class="nav-item nav-link btn btn-outline-success" href="mycart.php">Cart</a>
    </div>
  </div>
